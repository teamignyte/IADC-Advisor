...
Set **the Appian version** via `/iadc-advisor:setup` (or edit `docs/agents/project.md`). This affects:
...
- If the configured version is 26.5, use 26.6 for documentation URLs (documentation is compatible)
...
2. Suggest to user: "Using Appian 26.6 docs. To use a different version, set the `Appian version` line in docs/agents/project.md or re-run /iadc-advisor:setup."
