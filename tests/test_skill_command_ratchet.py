...
**Authored in IADC-Advisor.** IADC-Tester carries a mirror of this module, identical but for
SKILLS_ROOT and this paragraph, and its own baseline. Change this copy first, then the mirror.
