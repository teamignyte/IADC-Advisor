...
Do not act on it until I confirm we have reached a shared understanding. And if I end early — before we get there — don't just stop: surface any unresolved contradiction among the decisions we reached so I can settle it, and make sure everything I did decide is preserved by whatever's carrying state (in a `/interrogate-with-docs` session, written to `CONTEXT.md`/ADRs; in a bare stateless session, summarized back to me). Never leave decisions that still contradict each other.
